...
class TestAnnotations(unittest.TestCase):
    def test_restrictAnnotation(self):
        ...
        self.assertEqual(an1.generateCodeFor(field1), "msg.test().size() < 10")
        self.assertEqual(an1.generateCodeFor(field2), "msg.test_size() < 10")
        ...
        self.assertEqual(an2.generateCodeFor(field3), "msg.test() < 10")
        self.assertEqual(an2.generateCodeFor(field4), "(msg.has_test() && msg.test() < 10)")
