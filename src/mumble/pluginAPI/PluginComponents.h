...
struct MumbleAPI {
	...
	/// @returns The error code. If everything went well, STATUS_OK will be returned. Only then the passed pointer
	/// 	may be accessed
	MumbleError_t (PLUGIN_CALLING_CONVENTION *getUserName)(MumbleConnection_t connection, MumbleUserID_t userID, const char **userName);
	...
	/// @returns The error code. If everything went well, STATUS_OK will be returned. Only then the passed pointer
	/// 	may be accessed
	MumbleError_t (PLUGIN_CALLING_CONVENTION *getChannelName)(MumbleConnection_t connection, MumbleChannelID_t channelID, const char **channelName);
